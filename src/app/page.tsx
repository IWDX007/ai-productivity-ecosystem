...
export default function HomePage() {
  ...
  const popularTools = [
    { name: 'Word Counter', slug: 'text/word-counter', category: 'Text', icon: Type, color: 'text-purple-500', bg: 'bg-purple-500/10', description: 'Count words, characters instantly' },
    { name: 'Case Converter', slug: 'text/case-converter', category: 'Text', icon: Type, color: 'text-purple-500', bg: 'bg-purple-500/10', description: 'UPPER, lower, Title case converter' },
    { name: 'Lorem Ipsum', slug: 'text/lorem-ipsum', category: 'Text', icon: Type, color: 'text-purple-500', bg: 'bg-purple-500/10', description: 'Generate placeholder text instantly' },
    { name: 'PDF Merger', slug: 'pdf/pdf-merger', category: 'PDF', icon: FileText, color: 'text-red-500', bg: 'bg-red-500/10', description: 'Combine multiple PDFs into one' },
    { name: 'PDF Splitter', slug: 'pdf/pdf-splitter', category: 'PDF', icon: FileText, color: 'text-red-500', bg: 'bg-red-500/10', description: 'Split PDF into separate pages' },
    { name: 'PDF Compressor', slug: 'pdf/pdf-compressor', category: 'PDF', icon: FileText, color: 'text-red-500', bg: 'bg-red-500/10', description: 'Reduce PDF file size easily' },
    { name: 'BMI Calculator', slug: 'calculators/bmi-calculator', category: 'Calculator', icon: Calculator, color: 'text-pink-500', bg: 'bg-pink-500/10', description: 'Calculate your Body Mass Index' },
    { name: 'Age Calculator', slug: 'calculators/age-calculator', category: 'Calculator', icon: Calculator, color: 'text-pink-500', bg: 'bg-pink-500/10', description: 'Calculate age from date of birth' },
    { name: 'Percentage Calc', slug: 'calculators/percentage-calculator', category: 'Calculator', icon: Calculator, color: 'text-pink-500', bg: 'bg-pink-500/10', description: 'Calculate percentages easily' },
    { name: 'Image Compressor', slug: 'image/image-compressor', category: 'Image', icon: ImageIcon, color: 'text-blue-500', bg: 'bg-blue-500/10', description: 'Reduce image size, keep quality' },
    { name: 'Image Resizer', slug: 'image/image-resizer', category: 'Image', icon: ImageIcon, color: 'text-blue-500', bg: 'bg-blue-500/10', description: 'Resize images to any dimension' },
    { name: 'Image Converter', slug: 'image/image-converter', category: 'Image', icon: ImageIcon, color: 'text-blue-500', bg: 'bg-blue-500/10', description: 'Convert PNG, JPG, WebP formats' },
    { name: 'Password Generator', slug: 'security/password-generator', category: 'Security', icon: Lock, color: 'text-orange-500', bg: 'bg-orange-500/10', description: 'Create strong secure passwords' },
    { name: 'Hash Generator', slug: 'developer/hash-generator', category: 'Security', icon: Lock, color: 'text-orange-500', bg: 'bg-orange-500/10', description: 'MD5, SHA-256 hash generator' },
    { name: 'QR Generator', slug: 'qr-barcode/qr-code-generator', category: 'QR Code', icon: QrCode, color: 'text-cyan-500', bg: 'bg-cyan-500/10', description: 'Generate QR codes instantly' },
    { name: 'WiFi QR Code', slug: 'qr-barcode/wifi-qr-generator', category: 'QR Code', icon: QrCode, color: 'text-cyan-500', bg: 'bg-cyan-500/10', description: 'Share WiFi via QR code' },
    { name: 'JSON Formatter', slug: 'developer/json-formatter', category: 'Developer', icon: Code, color: 'text-green-500', bg: 'bg-green-500/10', description: 'Format and validate JSON data' },
    { name: 'Base64 Encoder', slug: 'developer/base64-encoder', category: 'Developer', icon: Code, color: 'text-green-500', bg: 'bg-green-500/10', description: 'Encode/decode Base64 strings' },
    { name: 'Length Converter', slug: 'converters/length-converter', category: 'Converter', icon: Ruler, color: 'text-indigo-500', bg: 'bg-indigo-500/10', description: 'Convert meters, feet, inches' },
    { name: 'Currency Converter', slug: 'converters/currency-converter', category: 'Converter', icon: Ruler, color: 'text-indigo-500', bg: 'bg-indigo-500/10', description: 'Convert between currencies' },
  ]
