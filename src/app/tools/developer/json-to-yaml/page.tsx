...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "json-to-yaml");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/json-to-yaml`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="json-to-yaml" toolName={tool.name} category="developer" />
    </>
  );
}