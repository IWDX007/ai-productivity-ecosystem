...
export default function JwtDecoderPage() {
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
          ...
          result.error ? (
            ...
            <div className="space-y-4">
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="text-theme-muted text-xs mt-2">⚠️ Signature verification requires the secret key (not done client-side for security)</p>
              </div>
            </div>
          )
        )}
      ...
      <SEOSections toolSlug="jwt-decoder" toolName="JWT Decoder" category="Developer" />
    </div>
  )
}