...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "color-picker");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/color-picker`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="color-picker" toolName={tool.name} category="developer" />
    </>
  );
}