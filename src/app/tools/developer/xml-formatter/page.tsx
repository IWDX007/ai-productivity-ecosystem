...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "xml-formatter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/xml-formatter`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="xml-formatter" toolName={tool.name} category="developer" />
    </>
  );
}