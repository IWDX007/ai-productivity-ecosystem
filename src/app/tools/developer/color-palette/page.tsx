...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "color-palette");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/color-palette`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="color-palette" toolName={tool.name} category="developer" />
    </>
  );
}