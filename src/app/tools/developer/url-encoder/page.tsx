...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "url-encoder");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/url-encoder`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="url-encoder" toolName={tool.name} category="developer" />
    </>
  );
}