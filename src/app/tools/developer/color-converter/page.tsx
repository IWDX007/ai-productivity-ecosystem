...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "color-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/color-converter`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="color-converter" toolName={tool.name} category="developer" />
    </>
  );
}