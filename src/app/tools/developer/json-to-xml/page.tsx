...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "json-to-xml");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/json-to-xml`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="json-to-xml" toolName={tool.name} category="developer" />
    </>
  );
}