...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "csv-to-json");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/csv-to-json`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="csv-to-json" toolName={tool.name} category="developer" />
    </>
  );
}