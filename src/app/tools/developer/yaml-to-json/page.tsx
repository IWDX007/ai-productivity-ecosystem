...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "yaml-to-json");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/yaml-to-json`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="yaml-to-json" toolName={tool.name} category="developer" />
    </>
  );
}