...
import HtmlPreviewClient from "./HtmlPreviewClient";
import SEOSections from "@/components/tools/SEOSections";
import { ToolSchema } from "@/components/seo/SchemaMarkup";

export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "html-preview");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/html-preview`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="html-preview" toolName={tool.name} category="developer" />
    </>
  );
}