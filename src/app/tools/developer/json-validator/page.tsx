...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("developer", "json-validator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/developer/json-validator`}
        category="developer"
    ...
    />
      <SEOSections toolSlug="json-validator" toolName={tool.name} category="developer" />
    </>
  );
}