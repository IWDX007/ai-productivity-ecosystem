...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("security", "uuid-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/security/uuid-generator`}
        category="security"
    ...
    />
      <SEOSections toolSlug="uuid-generator" toolName={tool.name} category="security" />
    </>
  );
}