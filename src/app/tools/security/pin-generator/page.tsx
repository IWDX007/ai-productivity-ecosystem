...
import PinGeneratorClient from "./PinGeneratorClient";
import SEOSections from "@/components/tools/SEOSections";
import { ToolSchema } from "@/components/seo/SchemaMarkup";

export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("security", "pin-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/security/pin-generator`}
        category="security"
    ...
    />
      <SEOSections toolSlug="pin-generator" toolName={tool.name} category="security" />
    </>
  );
}