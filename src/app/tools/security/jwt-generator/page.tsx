...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("security", "jwt-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/security/jwt-generator`}
        category="security"
    ...
    />
      <SEOSections toolSlug="jwt-generator" toolName={tool.name} category="security" />
    </>
  );
}