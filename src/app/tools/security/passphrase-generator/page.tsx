...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("security", "passphrase-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/security/passphrase-generator`}
        category="security"
    ...
    />
      <SEOSections toolSlug="passphrase-generator" toolName={tool.name} category="security" />
    </>
  );
}