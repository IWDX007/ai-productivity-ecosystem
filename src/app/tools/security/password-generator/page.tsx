...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("security", "password-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/security/password-generator`}
        category="security"
    ...
    />
      <SEOSections toolSlug="password-generator" toolName={tool.name} category="security" />
    </>
  );
}