...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "compound-interest");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/compound-interest`}
    ...
    />
      <SEOSections toolSlug="compound-interest" toolName={tool.name} category="calculators" />
    </>
  );
}