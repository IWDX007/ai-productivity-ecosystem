...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "water-intake");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/water-intake`}
    ...
    />
      <SEOSections toolSlug="water-intake" toolName={tool.name} category="calculators" />
    </>
  );
}