...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "bmi-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/bmi-calculator`}
    ...
    />
      <SEOSections toolSlug="bmi-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}