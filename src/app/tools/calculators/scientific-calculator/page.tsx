...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            <button onClick={back} className="p-4 bg-yellow-500/10 hover:bg-yellow-500/20 rounded-lg text-lg font-bold text-yellow-500 transition-colors col-span-1">←</button>
      ...
      <SEOSections toolSlug="scientific-calculator" toolName="Scientific Calculator" />
    </>
  )
}