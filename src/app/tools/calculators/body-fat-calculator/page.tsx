...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "body-fat-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/body-fat-calculator`}
    ...
    />
      <SEOSections toolSlug="body-fat-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}