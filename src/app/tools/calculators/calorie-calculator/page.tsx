...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "calorie-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/calorie-calculator`}
    ...
    />
      <SEOSections toolSlug="calorie-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}