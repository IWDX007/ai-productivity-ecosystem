...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "tax-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/tax-calculator`}
    ...
    />
      <SEOSections toolSlug="tax-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}