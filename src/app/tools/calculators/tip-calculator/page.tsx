...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "tip-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/tip-calculator`}
    ...
    />
      <SEOSections toolSlug="tip-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}