...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "retirement-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/retirement-calculator`}
    ...
    />
      <SEOSections toolSlug="retirement-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}