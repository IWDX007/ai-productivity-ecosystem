...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "date-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/date-calculator`}
    ...
    />
      <SEOSections toolSlug="date-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}