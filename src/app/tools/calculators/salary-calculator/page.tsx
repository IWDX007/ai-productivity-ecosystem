...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "salary-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/salary-calculator`}
    ...
    />
      <SEOSections toolSlug="salary-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}