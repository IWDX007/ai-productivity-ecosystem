...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("calculators", "loan-calculator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/calculators/loan-calculator`}
    ...
    />
      <SEOSections toolSlug="loan-calculator" toolName={tool.name} category="calculators" />
    </>
  );
}