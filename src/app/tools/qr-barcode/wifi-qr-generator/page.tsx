...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("qr-barcode", "wifi-qr-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/qr-barcode/wifi-qr-generator`}
        category="qr-barcode"
    ...
    />
      <SEOSections toolSlug="wifi-qr-generator" toolName={tool.name} category="qr-barcode" />
    </>
  );
}