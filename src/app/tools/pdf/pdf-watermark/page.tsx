...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("pdf", "pdf-watermark");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/pdf/pdf-watermark`}
        category="pdf"
    ...
    />
      <SEOSections toolSlug="pdf-watermark" toolName={tool.name} category="pdf" />
    </>
  );
}