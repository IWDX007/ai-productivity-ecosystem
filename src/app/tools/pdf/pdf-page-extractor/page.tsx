...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("pdf", "pdf-page-extractor");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/pdf/pdf-page-extractor`}
        category="pdf"
    ...
    />
      <SEOSections toolSlug="pdf-page-extractor" toolName={tool.name} category="pdf" />
    </>
  );
}