...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("pdf", "pdf-metadata-editor");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/pdf/pdf-metadata-editor`}
        category="pdf"
    ...
    />
      <SEOSections toolSlug="pdf-metadata-editor" toolName={tool.name} category="pdf" />
    </>
  );
}