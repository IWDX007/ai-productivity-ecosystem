...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "text-to-speech");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/text-to-speech`}
        category="text"
    ...
    />
      <SEOSections toolSlug="text-to-speech" toolName={tool.name} category="text" />
    </>
  );
}