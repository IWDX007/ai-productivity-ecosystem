...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "speech-to-text");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/speech-to-text`}
        category="text"
    ...
    />
      <SEOSections toolSlug="speech-to-text" toolName={tool.name} category="text" />
    </>
  );
}