...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "lorem-ipsum");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/lorem-ipsum`}
        category="text"
    ...
    />
      <SEOSections toolSlug="lorem-ipsum" toolName={tool.name} category="text" />
    </>
  );
}