...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "case-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/case-converter`}
        category="text"
    ...
    />
      <SEOSections toolSlug="case-converter" toolName={tool.name} category="text" />
    </>
  );
}