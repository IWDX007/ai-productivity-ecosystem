...
import ReadabilityScoreClient from "./ReadabilityScoreClient";
import SEOSections from "@/components/tools/SEOSections";
import { ToolSchema } from "@/components/seo/SchemaMarkup";

export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "readability-score");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/readability-score`}
        category="text"
    ...
    />
      <SEOSections toolSlug="readability-score" toolName={tool.name} category="text" />
    </>
  );
}