...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "text-formatter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/text-formatter`}
        category="text"
    ...
    />
      <SEOSections toolSlug="text-formatter" toolName={tool.name} category="text" />
    </>
  );
}