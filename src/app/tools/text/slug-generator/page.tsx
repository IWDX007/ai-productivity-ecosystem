...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("text", "slug-generator");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/text/slug-generator`}
        category="text"
    ...
    />
      <SEOSections toolSlug="slug-generator" toolName={tool.name} category="text" />
    </>
  );
}