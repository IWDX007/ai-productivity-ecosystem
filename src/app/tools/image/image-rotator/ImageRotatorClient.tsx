...
interface ImageRotatorPageProps {
  name?: string;
  description?: string;
}

export default function ImageRotatorPage({ name, description }: ImageRotatorPageProps) {
        ...
        <div className="glass-card rounded-2xl p-6 md:p-8 mb-8 max-w-5xl mx-auto">
          ...
          {originalFile && (
            <>
              ...
              <div className="mb-6">
                <label className="text-sm text-theme-muted mb-2 block">Custom Angle: {angle}Ãƒâ€šÃ‚Â°</label>
              ...
              {rotatedUrl && (
                <>
                  <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 mb-4">
                    <div className="text-sm text-blue-400 mb-2">Rotated {angle}Ãƒâ€šÃ‚Â°:</div>
