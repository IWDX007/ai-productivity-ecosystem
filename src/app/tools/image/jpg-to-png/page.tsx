...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
      <ToolPageMeta title="JPG to PNG" description="Convert JPG images to PNG format. Enable transparency support and lossless quality for graphics and logos." keywords="jpg to png, free online tool, jpg-to-png, image tools, ai productivity" />
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12 mt-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-theme-primary">
            JPG to <span className="gradient-text">PNG</span>
          </h1>
          <p className="text-theme-secondary max-w-2xl mx-auto">
            Convert JPG images to PNG format. Enable transparency support and lossless quality for graphics and logos.
          </p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 md:p-8 mb-8 max-w-4xl mx-auto">
          ...
          <button onClick={() => fileInputRef.current?.click()}
            ...
            <span>Click to upload JPG image</span>
          </button>

          {originalFile && (
            <>
              <div className="flex items-center justify-center gap-4 mb-6">
                <div className="px-4 py-2 bg-theme-secondary rounded-lg text-theme-primary">JPG</div>
        ...
        <SEOSections toolSlug="jpg-to-png" toolName="JPG to PNG Converter" category="Image" />
      </div>
    </div>
  )
}