...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("image", "base64-to-image");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/image/base64-to-image`}
        category="image"
    ...
    />
      <SEOSections toolSlug="base64-to-image" toolName={tool.name} category="image" />
    </>
  );
}