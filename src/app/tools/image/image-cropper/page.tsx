...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("image", "image-cropper");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/image/image-cropper`}
        category="image"
    ...
    />
      <SEOSections toolSlug="image-cropper" toolName={tool.name} category="image" />
    </>
  );
}