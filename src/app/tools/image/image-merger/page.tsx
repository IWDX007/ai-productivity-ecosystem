...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("image", "image-merger");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/image/image-merger`}
        category="image"
    ...
    />
      <SEOSections toolSlug="image-merger" toolName={tool.name} category="image" />
    </>
  );
}