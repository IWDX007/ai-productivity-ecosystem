...
export default function Page() {
  ...
  const convert = (file: File) => {
    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        setConvertedUrl(canvas.toDataURL("image/jpeg", quality / 100))
      }
    }
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
      <ToolPageMeta title="PNG to JPG" description="Convert PNG images to JPG format. Reduce file size while maintaining quality. Perfect for web use and email attachments." keywords="png to jpg, free online tool, png-to-jpg, image tools, ai productivity" />
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12 mt-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-theme-primary">
            PNG to <span className="gradient-text">JPG</span>
          </h1>
          <p className="text-theme-secondary max-w-2xl mx-auto">
            Convert PNG images to JPG format. Reduce file size while maintaining quality. Perfect for web use and email attachments.
          </p>
        </div>
          ...
          {originalFile && (
            <>
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <div className="px-4 py-2 bg-blue-500/10 border border-blue-500/30 rounded-lg text-blue-400">JPG</div>
              </div>
              ...
              {convertedUrl && (
                <>
                  ...
                  <button onClick={handleDownload}
                    ...
                    <Download className="w-5 h-5" /> Download as JPG
                  </button>
                </>
              )}
            </>
        ...
        <SEOSections toolSlug="png-to-jpg" toolName="PNG to JPG Converter" category="Image" />
      </div>
    </div>
  )
}