...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("image", "image-resizer");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/image/image-resizer`}
        category="image"
    ...
    />
      <SEOSections toolSlug="image-resizer" toolName={tool.name} category="image" />
    </>
  );
}