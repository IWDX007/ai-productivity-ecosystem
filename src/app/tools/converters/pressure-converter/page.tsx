...
import PressureConverterClient from "./PressureConverterClient";
import SEOSections from "@/components/tools/SEOSections";
import { ToolSchema } from "@/components/seo/SchemaMarkup";

export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "pressure-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/pressure-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="pressure-converter" toolName={tool.name} category="converters" />
    </>
  );
}