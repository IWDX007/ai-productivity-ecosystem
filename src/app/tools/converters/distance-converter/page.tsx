...
const UNITS: Record<string, { name: string; symbol: string; toBase: number }> = {
  ...
  au:          { name: "Astro Unit",    symbol: "AU",  toBase: 1.496e11 },
  lightYear:   { name: "Light Year",    symbol: "ly",  toBase: 9.461e15 },
}
...
export default function DistanceConverterPage() {
  ...
  const handleReset = () => { setValue("1"); setFromUnit("kilometer") }

  return (
    <div className="min-h-screen bg-theme-primary">
      <ToolPageMeta title="Distance Converter" description="Convert between km, miles, nautical miles, leagues, light years and more distance units. Perfect for travel, aviation and astronomy." keywords="distance converter, free online tool, distance-converter, converters tools, ai productivity" />
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12 mt-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-theme-primary">
            Distance <span className="gradient-text">Converter</span>
          </h1>
          <p className="text-theme-secondary max-w-2xl mx-auto">
            Convert between km, miles, nautical miles, leagues, light years and more distance units. Perfect for travel, aviation and astronomy.
          </p>
        </div>
        ...
        <SEOSections toolSlug="distance-converter" toolName="Distance Converter" category="Converter" />
      </div>
    </div>
  )
}