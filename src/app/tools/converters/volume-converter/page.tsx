...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "volume-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/volume-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="volume-converter" toolName={tool.name} category="converters" />
    </>
  );
}