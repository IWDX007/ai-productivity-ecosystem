...
const UNITS: Record<string, { name: string; symbol: string; toLiters: number }> = {
  ...
  cubicMeter:  { name: "Cubic Meter",  symbol: "m³",  toLiters: 1000 },
  cubicCm:     { name: "Cubic cm",     symbol: "cm³", toLiters: 0.001 },
  cubicInch:   { name: "Cubic Inch",   symbol: "in³", toLiters: 0.0163871 },
  cubicFoot:   { name: "Cubic Foot",   symbol: "ft³", toLiters: 28.3168 },
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <SEOSections toolSlug="volume-converter" toolName="Volume Converter" category="Converter" />
      </div>
    </div>
  )
}