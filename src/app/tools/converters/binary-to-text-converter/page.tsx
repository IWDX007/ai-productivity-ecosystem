...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "binary-to-text-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/binary-to-text-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="binary-to-text-converter" toolName={tool.name} category="converters" />
    </>
  );
}