...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "fuel-economy-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/fuel-economy-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="fuel-economy-converter" toolName={tool.name} category="converters" />
    </>
  );
}