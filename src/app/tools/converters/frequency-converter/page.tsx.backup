...
const UNITS: Record<string, { name: string; symbol: string; toBase: number }> = {
  ...
  rpm:        { name: "RPM",         symbol: "rpm", toBase: 0.0166667 },
  rps:        { name: "Rev/sec",     symbol: "rps", toBase: 1 },
  cyclePerHr: { name: "Cycles/hour", symbol: "cph", toBase: 0.000277778 },
  radPerSec:  { name: "Rad/sec",     symbol: "rad/s", toBase: 0.159155 },
  degPerSec:  { name: "Deg/sec",     symbol: "deg/s", toBase: 0.00277778 },
}
...
export default function FrequencyConverterPage() {
  ...
  const handleReset = () => { setValue("1"); setFromUnit("hertz") }

  return (
    <div className="min-h-screen bg-theme-primary">
      <ToolPageMeta title="Frequency Converter" description="Convert between Hertz, Kilohertz, Megahertz, RPM and more frequency units. Perfect for audio, radio and rotation calculations." keywords="frequency converter, free online tool, frequency-converter, converters tools, ai productivity" />
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-12 mt-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-theme-primary">
            Frequency <span className="gradient-text">Converter</span>
          </h1>
          <p className="text-theme-secondary max-w-2xl mx-auto">
            Convert between Hertz, Kilohertz, Megahertz, RPM and more frequency units. Perfect for audio, radio and rotation calculations.
          </p>
        </div>
        ...
        <SEOSections toolSlug="frequency-converter" toolName="Frequency Converter" category="Converter" />
      </div>
    </div>
  )
}