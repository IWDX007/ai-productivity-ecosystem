...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "temperature-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/temperature-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="temperature-converter" toolName={tool.name} category="converters" />
    </>
  );
}