...
const UNITS: Record<string, { name: string; symbol: string; toSqm: number }> = {
  ...
  sqMeter:   { name: "Square Meter",   symbol: "mÃ‚Â²",    toSqm: 1 },
  sqKm:      { name: "Square Km",      symbol: "kmÃ‚Â²",   toSqm: 1e6 },
  sqInch:    { name: "Square Inch",    symbol: "inÃ‚Â²",   toSqm: 0.00064516 },
  sqFoot:    { name: "Square Foot",    symbol: "ftÃ‚Â²",   toSqm: 0.092903 },
  sqYard:    { name: "Square Yard",    symbol: "ydÃ‚Â²",   toSqm: 0.836127 },
  sqMile:    { name: "Square Mile",    symbol: "miÃ‚Â²",   toSqm: 2589988 },
