...
export default function DateFormatConverterPage() {
  ...
  const formats = [
    ...
    { key: "chinese", name: "Chinese Format", value: isNaN(date.getTime()) ? "Invalid" : `${date.getUTCFullYear()}年${(date.getUTCMonth() + 1)}月${date.getUTCDate()}日` },
  ]
  ...
  return (
    <div className="min-h-screen bg-theme-primary">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <SEOSections toolSlug="date-format-converter" toolName="Date Format Converter" category="Converter" />
      </div>
    </div>
  )
}