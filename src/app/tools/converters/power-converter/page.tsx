...
import PowerConverterClient from "./PowerConverterClient";
import SEOSections from "@/components/tools/SEOSections";
import { ToolSchema } from "@/components/seo/SchemaMarkup";

export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "power-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/power-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="power-converter" toolName={tool.name} category="converters" />
    </>
  );
}