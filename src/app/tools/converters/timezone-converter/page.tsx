...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "timezone-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/timezone-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="timezone-converter" toolName={tool.name} category="converters" />
    </>
  );
}