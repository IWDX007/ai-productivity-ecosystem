...
export async function generateMetadata(): Promise<Metadata> {
  const tool = await getToolData("converters", "shoe-size-converter");
  ...
  return (
    <>
      ...
      <ToolSchema
        name={tool.name}
        description={tool.metaDescription || tool.description || ""}
        url={`https://ai-productivity-ecosystem-azure.vercel.app/tools/converters/shoe-size-converter`}
        category="converters"
    ...
    />
      <SEOSections toolSlug="shoe-size-converter" toolName={tool.name} category="converters" />
    </>
  );
}